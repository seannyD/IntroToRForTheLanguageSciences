...
In this tutorial, we'll load some data from a file. 
...
Set the working directory using the function `setwd`. I've set up a folder for this course:

```{r eval=F}
setwd("~/Documents/Teaching/CARDIFF/RCourse/IntroToR")
```
